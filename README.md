...
### Displaying a Table of Content

Once you have fetched the content, you can display the content in a rich table
format  using the provided `rscpages` function. This renders a
[reactable](https://glin.github.io/reactable/) table that includes searching,
sorting, paginating, and filtering.
