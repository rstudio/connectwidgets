...
RStudio Connect will [automatically apply](https://docs.rstudio.com/connect/user/content-settings/#content-vars)
...
`connectwidgets` components support styling in `rmarkdown::html_document` via the `bslib` package.
...
or pass in other customizations consistent with your organization's style.
